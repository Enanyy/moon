...
CREATE TABLE TB_Role (id INT NOT NULL DEFAULT (0),name VARCHAR(256) NOT NULL ,type INT NOT NULL DEFAULT (1),height DECIMAL NOT NULL DEFAULT (1),desc TEXT  ,weigth DOUBLE NOT NULL DEFAULT (0),config INT NOT NULL DEFAULT (0));
